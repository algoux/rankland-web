...
async function expectNoHorizontalDocumentOverflow(page: Page) {
  await expect.poll(
    ...
    { message: 'horizontal document overflow should settle after async app shell styles load' },
...
test.describe('app shell full-chain behavior', () => {
  ...
  test('renders the global shell with navigation and site switch on normal routes', async ({ page, request }) => {
    ...
    await expect(page.locator('[data-id="app-site-switch-link"]')).toHaveAttribute('target', '_blank');
