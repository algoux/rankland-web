...
本文档描述 `/api/v2/files` 文件接口、`file` 表、Tencent Cloud COS Provider 和比赛 `srkFileID` 关联规则。
...
```text
110000 FileNotFound
110001 FileInvalidName
110002 FileUploadTooLarge
110003 FileUploadAccessDenied
110004 FileUploadUnavailable
110099 FileUploadUnknown
```
