...
- Current slice: Collection remaining-height/pixel animation parity
- Latest slice commit: `feat: 收口合集页高度动画一致性` (this commit)
- Last recorded full gate: `corepack pnpm test:migration` passed build, 28 unit files / 137 unit tests, 1 SSR smoke test, 1 shallow Playwright test, and 40 full-chain Playwright tests across all migrated public routes during 2026-05-26 Collection remaining-height/pixel animation parity pre-commit verification
